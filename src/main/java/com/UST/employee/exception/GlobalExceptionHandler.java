...
import com.UST.employee.model.ErrorMessage;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ErrorMessage> handleException1(EmployeeAlreadyPresentException emp){
        ErrorMessage error = new ErrorMessage(HttpStatus.CONFLICT,emp.getMessage());
